...
Mobile.startApplication('mobileapp\\Happy Day Shopping.apk', true)
...
Mobile.tap(findTestObject('Object Repository/Shop/android.widget.EditText - 1'), 0)

Mobile.setText(findTestObject('Object Repository/Shop/android.widget.EditText - 1 (1)'), '5', 0)
